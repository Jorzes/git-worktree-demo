        ...
        <header className="navbar" role="banner">
            <div className="navbar__inner container">
                ...
                >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginTop: menuOpen ? '1rem' : '0' }}>
                        <ThemeToggle />
                        <a href="#demo" className="btn btn--primary btn--sm navbar__cta" style={{ marginTop: 0 }}>
                            預約 Demo
                        </a>
                    </div>
                </nav>
